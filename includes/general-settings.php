...
function edu_render_general_settings() {
	...
	<div class="eduadmin wrap">
			...
			<div class="block">
				...
				<table>
					<tr>
						...
						<td>
							<i title="<?php esc_attr_e( "Shortcode to use in your page", 'eduadmin-booking' ); ?>">[eduadmin-programme-list]</i>
						</td>
					</tr>
					<tr>
						<td><?php _e( "Detail view page", 'eduadmin-booking' ); ?></td>
						<td>
						...
						<td>
							<i title="<?php esc_attr_e( "Shortcode to use in your page", 'eduadmin-booking' ); ?>">[eduadmin-programme-detail]</i>
						</td>
					</tr>
					<tr>
						<td><?php _e( "Booking view page", 'eduadmin-booking' ); ?></td>
						<td>
						...
						<td>
							<i title="<?php esc_attr_e( "Shortcode to use in your page", 'eduadmin-booking' ); ?>">[eduadmin-programme-book]</i>
						</td>
					</tr>
				</table>
		...
		<form action="" method="POST">
			...
			<input type="submit" class="button button-primary" value="<?php esc_attr_e( "Clear transients/cache", 'eduadmin-booking' ); ?>" />
		</form>
	</div>
