	...
	<div class="discountView">
		<label>
			...
			<div class="inputHolder">
				<input type="text" autocomplete="off" name="edu-discountCode" id="edu-discountCode" class="discount-box"
				       placeholder="<?php echo esc_attr_x( 'Discount code', 'frontend', 'eduadmin-booking' ); ?>" />
				<button class="validateDiscount neutral-btn"
				        data-programmestartid="<?php echo esc_attr( $programme['ProgrammeStartId'] ); ?>"
				        onclick="eduBookingView.ValidateProgrammeDiscountCode(); return false;">
