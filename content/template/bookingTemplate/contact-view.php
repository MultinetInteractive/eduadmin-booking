...
<div class="contactView">
	...
	<label onclick="event.preventDefault()" class="edu-book-contact-contactName">
		...
		<div class="inputHolder"><input type="text"
				...
				required onchange="eduBookingView.ContactAsParticipant();" autocomplete="off" class="first-name" id="edu-contactFirstName" name="contactFirstName" placeholder="<?php echo esc_attr_x( 'Contact first name', 'frontend', 'eduadmin-booking' ); ?>" value="<?php echo @esc_attr( $contact->FirstName ); ?>" /><input type="text" <?php echo( $__block ? ' readonly' : '' ); ?>
				required onchange="eduBookingView.ContactAsParticipant();" id="edu-contactLastName" class="last-name" autocomplete="off" name="contactLastName" placeholder="<?php echo esc_attr_x( 'Contact surname', 'frontend', 'eduadmin-booking' ); ?>" value="<?php echo @esc_attr( $contact->LastName ); ?>" />
		</div>
	</label>
	<label class="edu-book-contact-contactEmail">
		...
		<div class="inputHolder">
			<input type="email" id="edu-contactEmail" required name="contactEmail"<?php echo( $__block ? ' readonly' : '' ); ?> autocomplete="off" onchange="eduBookingView.ContactAsParticipant();" placeholder="<?php echo esc_attr_x( 'E-mail address', 'frontend', 'eduadmin-booking' ); ?>" value="<?php echo @esc_attr( $contact->Email ); ?>" />
		</div>
	</label>
