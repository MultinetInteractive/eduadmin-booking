	...
	<form method="POST" class="search-form">
		<table style="width: 100%;">
			<tr>
				...
				<?php } ?>
				<td>
					<input class="edu-searchTextBox" type="search" name="searchCourses" results="10" autosave="edu-course-search_<?php echo $apiUserId; ?>" placeholder="<?php edu_e("Search courses"); ?>"<?php if(isset($_REQUEST['searchCourses'])) { echo " value=\"" . $_REQUEST['searchCourses'] . "\""; }?> />
				</td>
				<td style="width: 10%;">
