<div class="eduadmin loginForm">
	<div class="loginBox">
		...
		<form action="" method="POST" onsubmit="">
			...
			?>
			<button class="loginButton cta-btn" onclick="this.form.eduadminpassword.required = true; this.form.eduformloginaction.value = 'login';<?php echo esc_attr( $click ); ?>"><?php echo esc_html_x( 'Log in', 'frontend', 'eduadmin-booking' ); ?></button>
			<button class="forgotPasswordButton neutral-btn" onclick="this.form.eduadminpassword.required = false; this.form.eduadminpassword.value = ''; this.form.eduformloginaction.value = 'forgot';"><?php echo esc_html_x( 'Forgot password', 'frontend', 'eduadmin-booking' ); ?></button>
		</form>
	</div>
